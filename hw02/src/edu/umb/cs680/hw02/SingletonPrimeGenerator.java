...
public class SingletonPrimeGenerator {
    ...
    private static SingletonPrimeGenerator singleton;
    ...
    public static SingletonPrimeGenerator getInstance() {
        ...
        if (singleton == null) {
            singleton = new SingletonPrimeGenerator();
        }
    ...
    public void primeGenerator(long from, long to){
        if(from >= 1 && to > from){
            this.from = from;
            this.to = to;
        }else{
